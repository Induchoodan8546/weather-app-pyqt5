...
class WeatherApp(QWidget):
    ...
    def initUI(self):
        ...
        self.setStyleSheet("""
                           ...
                           QPushButton#get_Weather_button{
                            font-size: 30px;
                            font-weight: bold;}
                           QLabel#temperature_label, QLabel#emoji_label, QLabel#description_label{
                            font-size: 75px;}
                           QLabel#emoji_label{
                            font-size: 100px;
    ...
    def get_weather(self):
        api_key = "ccd01c1719b51e529890485255aefb49"
    ...
    def display_weather(self, data):
        ...
        temperature_f = round((temperature_kelvin - 273.15) * 9/5 + 32, 1)
